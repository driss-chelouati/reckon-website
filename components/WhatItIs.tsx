    ...
    <>
      <div className="band">
        <div className="mani" id="what-it-is">
          <div className="srail"><span className="l">What it is</span><span className="r">Rules · shells · tokens</span></div>
          <p className="manih"><b>A design system whose product is the rules.</b> It ships components and tokens, but those are the easy part. What it actually carries is a rules layer that tells a design agent how to assemble a screen and derive the numbers on it — for dense, record-centric software where people act on a queue before a clock runs out.</p>
          ...
          <div className="figs">
            <div className="fig">
              ...
              <div className="figart">
                <svg viewBox="0 0 300 300" aria-hidden="true">
                  ...
                  <defs><linearGradient id="g1" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stopColor="rgba(249,122,92,.30)" /><stop offset="1" stopColor="rgba(249,122,92,0)" /></linearGradient></defs>
                  </svg>
              </div>
              <h3>Every figure names its data</h3>
              <p>One convention runs through everything. Status is data; derived state is not — overdue is computed, never stored. And a new status value is never absorbed on the model’s judgement. It stops and asks.</p>
            </div>
            ...
            <div className="fig">
              ...
              <div className="figart">
                <svg viewBox="0 0 300 300" aria-hidden="true">
                  <g className="sh2"><path className="ln dim fillp" d="M150,176 L268,236 L150,296 L32,236 Z" /></g>
                  ...
                  <g className="sh3"><path className="ln dim fillp" d="M150,45 L230,86 L150,127 L70,86 Z" /><path className="ln hot sbar" style={{ animationDelay: ".2s" }} d="M112,86 L150,67 L188,86" /></g>
                  </svg>
              </div>
              <h3>Rules for the shell, and room inside them</h3>
              <p>Specialised guidance for the parts every business app grows: shells, work queues, record pages, decision surfaces. Each one names three expressive choices and a reason for each — the room where your product becomes recognisably yours.</p>
            </div>
            ...
            <div className="fig">
              ...
              <div className="figart">
                <svg viewBox="0 0 300 300" aria-hidden="true">
                  <g className="shdw" style={{ transformBox: "fill-box", transformOrigin: "50% 50%" }}><path className="ln dim" fill="rgba(255,255,255,.02)" d="M150,232 L262,289 L150,290 L38,289 Z" opacity=".8" /></g>
                  <g className="cube" style={{ "--dx": "0.0px", "--dy": "7.0px", animationDelay: "0.00s" } as React.CSSProperties}>
                  ...
                  <g className="cube" style={{ "--dx": "62.0px", "--dy": "37.0px", animationDelay: "0.03s" } as React.CSSProperties}>
                  ...
                  <g className="cube" style={{ "--dx": "-62.0px", "--dy": "37.0px", animationDelay: "0.06s" } as React.CSSProperties}>
                  ...
                  <g className="cube" style={{ "--dx": "0.0px", "--dy": "67.0px", animationDelay: "0.09s" } as React.CSSProperties}>
                  ...
                  <g className="cube" style={{ "--dx": "0.0px", "--dy": "-67.0px", animationDelay: "0.12s" } as React.CSSProperties}>
                  ...
                  <g className="cube" style={{ "--dx": "62.0px", "--dy": "-37.0px", animationDelay: "0.15s" } as React.CSSProperties}>
                  ...
                  <g className="cube" style={{ "--dx": "-62.0px", "--dy": "-37.0px", animationDelay: "0.18s" } as React.CSSProperties}>
                  ...
                  <g className="cube" style={{ "--dx": "0.0px", "--dy": "-7.0px", animationDelay: "0.21s" } as React.CSSProperties}>
              ...
              <p>Components and tokens you can point at your own brand, packaged so Claude Design picks them up on load. And where a rule can be enforced rather than described, it is — pagination derives its own total, so a footer cannot carry an invented number.</p>
            </div>
          </div>
        </div>
      </div>
